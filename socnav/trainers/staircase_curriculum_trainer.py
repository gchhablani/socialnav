...
@baseline_registry.register_trainer(name="staircase_curriculum_trainer")
class StaircaseCurriculumTrainer(PPOTrainer):
        ...
        with (
            ...
            while not self.is_done():
                ...
                if rank0_only():
                    ...
                    if self.num_steps_done >= self.last_curr_update_step + curriculum_config.update_curriculum_every_x_steps:
                        self.last_curr_update_step = self.num_steps_done
                        
                        self.gps_available_every_x_steps = min(
                            self.gps_available_every_x_steps + curriculum_config.staircase_increment, 
