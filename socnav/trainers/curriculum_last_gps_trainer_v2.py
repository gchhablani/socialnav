...
@baseline_registry.register_trainer(name="curriculum_last_gps_trainer_v2")
class CurriculumLastGpsTrainerV2(PPOTrainer):
    
    def __init__(self, config=None):
        super().__init__(config)
        self.gps_available_every_x_steps = self.config.habitat.gps_available_every_x_steps
        self.has_found_human = 0
        self.first_known_gps_encountered = False
