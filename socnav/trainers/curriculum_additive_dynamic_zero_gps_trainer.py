...
@baseline_registry.register_trainer(name="curriculum_additive_dynamic_zero_gps_trainer")
class CurriculumAdditiveDynamicZeroGpsTrainer(PPOTrainer):
    ...
    def __init__(self, config=None):
        ...
        self.curriculum_dynamic_scale_factor = self.config.habitat.curriculum_dynamic_scale_factor
        self.curriculum_dynamic_axis = self.config.habitat.curriculum_dynamic_axis
        ...
        with (
            ...
            while not self.is_done():
                ...
                if rank0_only():
                    ...
                    #     self.gps_available_every_x_steps = max(self.gps_available_every_x_steps + adjustment, 1)

                    adjustment = int((self.has_found_human - self.curriculum_dynamic_axis) // self.curriculum_dynamic_scale_factor)
