#!/bin/bash
#SBATCH --job-name=s-eval-lgps
#SBATCH --output=slurm_logs/eval/socialnav-eval-ddppo-lgps-%j.out
#SBATCH --error=slurm_logs/eval/socialnav-eval-ddppo-lgps-%j.err
#SBATCH --gpus a40:1
...
JOB_ID="socnav_ddppo_baseline_multi_gpu_full-lgps"
