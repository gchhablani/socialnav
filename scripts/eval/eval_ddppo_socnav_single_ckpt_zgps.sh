...
JOB_ID="socnav_ddppo_full_curr_mul"
DATA_PATH="data/datasets/hssd/rearrange"
TENSORBOARD_DIR="tb/${JOB_ID}/final/ckpt_12_eval/"
CHECKPOINT_DIR="data/socnav_checkpoints/${JOB_ID}/final/ckpt.12.pth"
...
srun python -um socnav.run \
    ...
    habitat_baselines.video_dir="videos/mul_zgps/ckpt_12/" \
    ...
    habitat_baselines.evaluator._target_="socnav.trainers.evaluators.zero_gps_evaluator.ZeroGpsEvaluator" \
