#!/bin/bash
#SBATCH --job-name=snav-full-curriculum-additive-warmup-lower-staircase
#SBATCH --output=slurm_logs/train/socialnav-ddppo-full-curriculum-additive-warmup-lower-staircase-%j.out
#SBATCH --error=slurm_logs/train/socialnav-ddppo-full-curriculum-additive-warmup-lower-staircase-%j.err
#SBATCH --gpus a40:4
...
# wandb config
JOB_ID="socnav_ddppo_baseline_multi_gpu_full_curriculum_additive_warmup_lower_staircase"
# split="train"
...
srun python -um socnav.run \
    ...
    habitat.curriculum_config.warmup_steps=50000000 \
