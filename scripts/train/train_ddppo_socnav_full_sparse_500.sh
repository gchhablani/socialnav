#!/bin/bash
#SBATCH --job-name=snav-full-sparse-500
#SBATCH --output=slurm_logs/train/socialnav-ddppo-full-sparse-500-%j.out
#SBATCH --error=slurm_logs/train/socialnav-ddppo-full-sparse-500-%j.err
#SBATCH --gpus a40:4
...
# wandb config
JOB_ID="socnav_ddppo_baseline_multi_gpu_full_sparse_500"
# split="train"
