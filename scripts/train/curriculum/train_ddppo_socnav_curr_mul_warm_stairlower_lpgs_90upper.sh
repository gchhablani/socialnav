#!/bin/bash
#SBATCH --job-name=snav-curr-mul-warm-stair-lg
#SBATCH --output=slurm_logs/train/snav-curr-mul-warm-stair-lg-%j.out
#SBATCH --error=slurm_logs/train/snav-curr-mul-warm-stair-lg-%j.err
#SBATCH --gpus a40:4
...
# wandb config
JOB_ID="socnav_ddppo_full_curriculum_multiplicative_lower_staircase_lastgps_90_upper"
# split="train"
...
srun python -um socnav.run \
    ...
    habitat.curriculum_config.additive=False \
