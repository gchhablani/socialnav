#!/bin/bash
#SBATCH --job-name=snav-curr-dadd-warm-stair
#SBATCH --output=slurm_logs/train/snav-curr-dadd-warm-stair-%j.out
#SBATCH --error=slurm_logs/train/snav-curr-dadd-warm-stair-%j.err
#SBATCH --gpus a40:4
...
# wandb config
JOB_ID="socnav_ddppo_full_curriculum_dynamic_additive_lower_staircase"
# split="train"
