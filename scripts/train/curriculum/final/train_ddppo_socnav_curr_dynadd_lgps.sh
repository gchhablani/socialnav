#!/bin/bash
#SBATCH --job-name=snav-curr-dadd-lg
#SBATCH --output=slurm_logs/train/snav-curr-dadd-lg-%j.out
#SBATCH --error=slurm_logs/train/snav-curr-dadd-lg-%j.err
#SBATCH --gpus a40:4
...
# wandb config
JOB_ID="socnav_ddppo_full_curr_dynamic_add_last_gps"
# split="train"
...
CHECKPOINT_DIR="data/socnav_checkpoints/${JOB_ID}/final/"
