#!/bin/bash
#SBATCH --job-name=snav-curr-dadd
#SBATCH --output=slurm_logs/train/snav-curr-dadd-%j.out
#SBATCH --error=slurm_logs/train/snav-curr-dadd-%j.err
#SBATCH --gpus a40:4
...
# wandb config
JOB_ID="socnav_ddppo_full_curr_dynamic_add"
# split="train"
