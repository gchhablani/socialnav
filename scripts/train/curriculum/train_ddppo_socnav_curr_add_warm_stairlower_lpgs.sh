#!/bin/bash
#SBATCH --job-name=snav-curr-add-warm-stair-lg
#SBATCH --output=slurm_logs/train/snav-curr-add-warm-stair-lg-%j.out
#SBATCH --error=slurm_logs/train/snav-curr-add-warm-stair-lg-%j.err
#SBATCH --gpus a40:4
