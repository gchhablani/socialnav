#!/bin/bash
#SBATCH --job-name=snav-curr-add-warm-10M-stair-90
#SBATCH --output=slurm_logs/train/snav-curr-add-warm-10M-stair-90-%j.out
#SBATCH --error=slurm_logs/train/snav-curr-add-warm-10M-stair-90-%j.err
#SBATCH --gpus a40:4
...
# wandb config
JOB_ID="socnav_ddppo_full_curriculum_additive_lower_staircase_90_upper_warm_10M"
# split="train"
