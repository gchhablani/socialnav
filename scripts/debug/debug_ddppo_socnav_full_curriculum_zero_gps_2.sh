...
# wandb config
JOB_ID="socnav_ddppo_baseline_multi_gpu_full_curriculum_zero_gps"
DATA_PATH="data/datasets/hssd/rearrange"
WB_ENTITY="gchhablani"
PROJECT_NAME="socnav"
TENSORBOARD_DIR="tb/junk/${JOB_ID}/seed_2/"
CHECKPOINT_DIR="data/socnav_checkpoints/junk/${JOB_ID}/seed_2/"


srun python -um socnav.run \
    --config-name=experiments/ddppo_socnav_full_curriculum_zero_gps.yaml \
